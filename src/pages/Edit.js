...
export default class Edit extends Component {
  state = {
    ProfileSaved: JSON.parse(localStorage.getItem("ProfileSaved")) || [],
  };
  componentDidMount() {
    // localStorage.getItem("ProfileSaved")
    localStorage.setItem("ProfileSaved", JSON.stringify(this.state.ProfileSaved))
    // const LocalProfileSaved = localStorage.getItem("ProfileSaved");
    // const ProfileSaved = LocalProfileSaved ? JSON.parse(LocalProfileSaved) : [];
  ...
  render() {
    console.log(this.state.ProfileSaved);
    return (
      <Template {...this.props}>
        {/* <Form onSubmit={(e)=>this.onSave}> */}
        ...
        <Form onSubmit={this.onSave}>
          <Container>
            <Row>
              ...
              <Col md={10}>
              {this.state.ProfileSaved.map((item, i) => (
                    <h5 key={i}>
                    {item.UserName}
                    </h5>
                  ))}
